...
const PR_DESCRIPTION_MD = `Closes #{{ issue.number }}
...
completable: true
---
You are continuing work on a pull request. Reviewer feedback has been provided below.
...
export async function initCommand(cwd: string) {
  ...
  const files: [string, string][] = [
    ...
    [join(stormDir, "continue", "CONTINUE.md"), CONTINUE_MD],
    [join(stormDir, "pr", "PR_DESCRIPTION.md"), PR_DESCRIPTION_MD],
  ];
